...
<body>
	...
	<div class="container-wrapper">
		<div class="container">
			...
			<form:form action="/BooksCart/admin/addProduct" method="post"
				commandName="product" enctype="multipart/form-data" class="well">
				...
				<div class="form-group">
					<label for="category">Category</label> <label
						class="checkbox-inline"><form:radiobutton
							path="productCategory" id="category" value="Books" />Soft Cover</label>
					<label class="checkbox-inline"><form:radiobutton
							path="productCategory" id="category" value="Books" />Hard Cover</label>
				</div>
